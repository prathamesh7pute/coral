import type { Connection, HydratedDocument, Model, Mongoose, Types } from 'mongoose';
...
export default function buildModels(mongoose: Mongoose, connection: Connection): TestModels {
